...
def get_data():
    ...
    try:
        ...
        # Limit the training dataset to the first 5 images
...
def main():
    try:
        ...
        _iter = 0
        st_time = time.time()
        epochs = 20  # Change this to train for more epochs
        ...
        for epoch in range(epochs):
            ...
            for batch_idx, batch in enumerate(train_loader):
                try:
                    ...
                    # Ensure valid indices in objs_id
